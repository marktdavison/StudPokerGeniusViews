//
//  landscapeOddsViewController.swift
//  DeckOfCards
//
//  Created by Mark Davison on 20/11/2017.
...
class LandscapeOddsViewController: UIViewController {
    ...
    @IBAction func perspectiveSwitch(_ sender: UISwitch) {
        if perspectiveOutlet.isOn == true {
            ...
            perspectiveLabel.text = "Sneaky Peak"
    ...
    func configureView(){
        if let hand = self.handItem {
            self.playerLabel.text = "A Player"
